...
public class ForwardServer
{
    ...
    private void doHandshake() throws UnknownHostException, IOException, Exception {
        ...
        Handshake.Handshake(clientSocket, arguments.get("usercert"),"ServerHello");
        Handshake.VerifyClientHello(clientSocket, arguments.get("cacert"));
        Handshake.VerifyForward(clientSocket);
